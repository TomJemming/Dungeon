...
#crosshair
    ...
    def on_draw(self):
        ...
        arcade.draw_text(str(self.animation_timer_2), color = arcade.color.WHITE, start_x = 120, start_y = SCREEN_HEIGHT - 150)
